...
### Data Access
Since data access is critical to just about any app, I felt this demo would be incomplete without some kind of data access demo. My example diverges completely from the crypto theme, however.
